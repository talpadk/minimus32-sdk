...
#define	_PFF_USE_READ	1	/* 1:Enable pf_read() */

#define	_PFF_USE_DIR	1	/* 1:Enable pf_opendir() and pf_readdir() */

#define	_PFF_USE_LSEEK	1	/* 1:Enable pf_lseek() */

#define	_PFF_USE_WRITE	1	/* 1:Enable pf_write() */

#define _PFF_FS_FAT12	1	/* 1:Enable FAT12 support */
#define _PFF_FS_FAT32	1	/* 1:Enable FAT32 support */
